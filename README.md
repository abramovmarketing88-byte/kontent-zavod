...
**Или просто напиши боту в Telegram** (если `TELEGRAM_TOPIC_INTAKE=true`):

- текст: `у жизни нет черновика`
- голосовое с темой
- `/topic 5 способов экономить время с ИИ`

Крон каждые 15 минут подхватит сообщение, положит бриф в `inbox/topic.txt` и запустит run-once. Ответит в чат: «⏳ Делаю Reels…»
